...
\begin{figure}[h]
    \begin{subfigure}{0.49\textwidth}
        ...
        \caption{\label{fig:claypool_quality:fps}\begin{raggedright}Pelaajien antamat arvosanat suhteutettuna päivitystiheyteen. Resoluutio on 512x384 kuvapistettä.\end{raggedright}}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
