...
\title{WebGL-rajapinta HTML5-pelinkehittäjän näkökulmasta}
% 2-osainen otsikko:
...
\TITLE{WebGL-rajapinta HTML5-pelinkehittäjän näkökulmasta}
%\TITLE{\LaTeX{} för kandidatseminariet med jättelång rubrik som fortsätter och
% fortsätter ännu}
\ENTITLE{The WebGL API from an HTML5-game developer's perspective}
